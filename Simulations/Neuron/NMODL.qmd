...
The prupose is to define biophysical mechanisms such as ion channels, synaptic models, or custom current/voltage sources. These files extend NEURON's capabilities by specifying kinetic equations, state variables, and interactions with ions.
